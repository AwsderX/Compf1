    ...
    private void processSymbol(char c){
        switch(symType(c)){
            ...
            case SYM_RIGHT:
                ...
                break;
            case SYM_OPER:
                System.out.print(" "); //ЭТА СТРОЧКА РЕШАЕТ ВСЁ ЗАДАНИЕ. С этим пробелом всё числа в любом примере печатаются правильно, выходит, что это просто быстрое решение но только в рамках задания на отрисовку
                processSuspendedSymbols(c);
                push(c);
                break;
            case SYM_OTHER:
